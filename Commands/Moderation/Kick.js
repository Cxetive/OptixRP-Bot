...
module.exports = {
    ...
    .setName("kick")
    .setDescription("Kick een persoon uit de discord.")
    ...
    async execute(interaction) {
        ...
        .setAuthor({name: "Persoon kon niet gekicked worden."})
        .setColor("Red");
        ...
        errorsArray.push("De persoon die jij wilt kicken heeft een hogere role dan jou.");
        ...
        .setColor("#36393f")
        .setDescription([
            `👋 | Iemand is gekicked uit de discord.`,
            `\n`,
        ...
        new WebhookClient({ 
         ...
         interaction.reply({ 
            content: `${target} is nu gekicked uit de discord.`,
            ephemeral: true,
        })
